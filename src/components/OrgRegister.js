                ...
                <form onSubmit={handleSubmit} action=''>
                    <div className="row jumbotron box8">
                        <div className="col-sm-6 form-group">
                            <label htmlFor="name-f" className='mt-4'>First Name</label>
                            <input type="text" className="form-control" name="fname" id="name-f" placeholder="Enter your first name." required />
                        </div>
                        <div className="col-sm-6 form-group">
                            <label htmlFor="name-l" className='mt-4'>Last name</label>
                        ...
                        <div className="col-sm-6 form-group">
                            ...
                            <input type="address" className="form-control" name="Locality" id="address-1" placeholder="Locality/House/Street no." />
                        </div>
                        <div className="col-sm-6 form-group">
                        ...
                        <div className="col-sm-2 form-group">
                            <label htmlFor="zip" className='ml-2'>Postal-Code</label>
                            <input type="zip" className="form-control mr-10" name="Zip" id="zip" placeholder="Postal-Code." required />
                        </div>
                        <div className="col-sm-6 form-group">
                        ...
                        <div className="col-sm-2 form-group">
                            <label htmlFor="cod" className='ml-5'>Country code</label>
                        ...
                        <div className="col-sm-12">
                            <input type="checkbox" className="form-check d-inline mt-3" id="chb" required/><label htmlFor="chb" className="form-check-label">&nbsp;I accept all terms and conditions.
                            </label>
